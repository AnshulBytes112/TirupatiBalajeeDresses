-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CUSTOMER', 'ADMIN', 'STORE_STAFF');
...
-- CreateEnum
CREATE TYPE "InventoryTransactionType" AS ENUM ('PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'DAMAGE', 'RESTOCK');
...
-- CreateEnum
CREATE TYPE "BannerPosition" AS ENUM ('HERO', 'PROMO_SPLIT', 'PROMO_TRIO', 'TOP_BAR');
...
CREATE TABLE "school_uniforms" (
    ...
    CONSTRAINT "school_uniforms_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "products_status_isActive_isDeleted_idx" ON "products"("status", "isActive", "isDeleted");
...
-- CreateIndex
CREATE INDEX "school_uniforms_schoolId_idx" ON "school_uniforms"("schoolId");

-- CreateIndex
CREATE INDEX "school_uniforms_productId_idx" ON "school_uniforms"("productId");

-- CreateIndex
CREATE INDEX "school_uniforms_season_gender_idx" ON "school_uniforms"("season", "gender");

-- CreateIndex
CREATE UNIQUE INDEX "school_uniforms_schoolId_productId_season_gender_classGrade_key" ON "school_uniforms"("schoolId", "productId", "season", "gender", "classGrade");
...
-- CreateIndex
CREATE INDEX "coupons_isActive_isDeleted_idx" ON "coupons"("isActive", "isDeleted");
...
-- CreateIndex
CREATE INDEX "banners_position_isActive_isDeleted_idx" ON "banners"("position", "isActive", "isDeleted");
...
-- AddForeignKey
ALTER TABLE "school_uniforms" ADD CONSTRAINT "school_uniforms_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school_uniforms" ADD CONSTRAINT "school_uniforms_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
